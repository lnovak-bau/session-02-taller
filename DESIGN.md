...
- Shadows:
  - `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.04) 0px 0px 0px 1px inset`
...
Motion feels controlled and interface-led across text, layout, and section transitions. Timing clusters around 160ms and 200ms. Easing favors ease and `cubic-bezier(0.23, 1, 0.32, 1)`. Hover behavior focuses on text changes. Scroll choreography uses GSAP ScrollTrigger for section reveals and pacing.
